...
{
	// Get Y-direction global position. - This indicates the row of matrix_C's element that this OpenCL instance will compute.
	int row = get_global_id(1);

	// Get X-direction global position. - This indicates the column of matrix_C's element that this OpenCL instance will compute.
