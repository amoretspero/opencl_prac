...
int main(int argc, char** argv)
{
	...
	fopen_s(&opencl_kernel_file, "Prac5_VS2012_NVIDIA.cl", "r");
	...
	// For this 'clEnqueueReadBuffer operation, we can set 3rd argument as CL_FALSE, but to synchronize correctly, somethings like clFinish(queue) should be added right after.
